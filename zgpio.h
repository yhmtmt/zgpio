...
#define ZGPIO_IOSETGINT _IOW(ZGPIO_IOC_MAGIC, 5, int)
#define ZGPIO_IOSETINT _IOW(ZGPIO_IOC_MAGIC, 6, int)
#define ZGPIO_IOSETINT2 _IOW(ZGPIO_IOC_MAGIC, 7, int)
#define ZGPIO_IOC_MAXNR 7
